    ...
    <div style={{ background: '#003399', padding: '50px 0', textAlign: 'center', color: '#fff' }}>
      <Row justify="center">
        <Col>
          ...
          <Title level={1} style={{ color: '#fff', marginTop: '10px',fontFamily: 'Times New Roman, serif' }}>App Development</Title>
          ...
          Analyzinn Solutions develops high-performance mobile apps that enhance user experiences and drive business growth.
          </Text>
