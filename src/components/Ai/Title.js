    ...
    <div style={{ background: '#003399', padding: '50px 0', textAlign: 'center', color: '#fff' }}>
      <Row justify="center">
        <Col>
          ...
          <Title level={1} style={{ color: '#fff', marginTop: '10px',fontFamily: 'Times New Roman, serif' }}>Artificial Intelligence and Machine Learning</Title>
          ...
          Analyzinn Solutions develops cutting-edge AI and ML solutions that drive innovation and business growth.          </Text>
